...
> **Note**: Transcripts are gitignored — they stay local and aren't committed to the repo.
> This avoids bloating git history with multi-megabyte files.
> They're still retained via Dropbox sync.
